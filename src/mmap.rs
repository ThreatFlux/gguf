...
#[cfg(feature = "mmap")]
use crate::{error::Result, file::GGUFFile, GGUFError, GGUF_MAGIC, GGUF_VERSION};
...
mod tests {
    ...
    fn test_mmap_invalid_magic() {
        ...
        let result = GGUFFile::mmap(temp_file.path());
    ...
    fn test_mmap_reader() {
        ...
        let file = File::create("/tmp/test_gguf").unwrap();
